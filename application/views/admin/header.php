        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="javascript:void(0)">
                ...
                <b class="logo-icon p-l-10">
                    ...
                    <!-- Dark Logo icon -->
                    <img width="30px" src="<?= base_url('assets/');?>gtems/img/gtems.png" alt="homepage" class="light-logo" />
                ...
                <span class="logo-text">
                   <!-- dark Logo text -->
                   <img src="<?= base_url('assets/');?>images/text.png" alt="homepage" class="light-logo" />
