...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('');?>assets/gtems/img/gtems.png" >
    ...
    <link href="<?= base_url('assets/template/admin/');?>assets/libs/toastr/build/toastr.min.css" rel="stylesheet">
     <link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/myJs/print.min.css">
